...
@Configuration
@EnableConfigurationProperties(OfferHttpProperties::class)
class OfferHttpConfiguration {
    @Bean("offerServiceClientHttpRequestFactory")
    fun offerServiceClientHttpRequestFactory(
    ...
    @Bean("offerServiceRestClient")
    fun offerServiceRestClient(
